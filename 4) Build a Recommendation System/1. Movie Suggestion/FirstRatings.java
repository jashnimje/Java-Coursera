...
public class FirstRatings {
    ...
    public void testLoadMovies() {
        ...
        System.out.println("There are " + countComedies + " " + countInGenre + " Genre movies in the list");
        ...
        System.out.println("Maximum number of movies directed by one director: " + maxNumOfMovies);
        System.out.println("Directors with max no. of movies are " + directorsList);
    }
