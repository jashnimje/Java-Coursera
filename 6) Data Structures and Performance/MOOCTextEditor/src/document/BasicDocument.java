...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		List<String> patternWords = getTokens(pattern);
	    return patternWords.size();
	}
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		String pattern = "[^.?!]+";
		List<String> patternSentences = getTokens(pattern);
	    return patternSentences.size();
	}
	...
	public int getNumSyllables()
	{
		...
		List<String> patternWords = getTokens("[a-zA-Z]+");
